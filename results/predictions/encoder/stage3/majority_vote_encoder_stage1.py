...
# top per architecure after stage 3

#
# ENSEMBLE_FILES = [
#     "t1_deberta_en_base_unfreezing25_fixed_multiLayerHead_originalData_truncHeadTail_lossWCE_predictions.csv",
#     "t1_mdeberta_multi_base_unfreezing25_fixed_avgPoolHead_head_FOCAL_Dropout10_NoAug_predictions.csv",
#     "t1_bert_en_base_lora16_fixed_default_originalData_truncHeadTail_lossWCE_predictions.csv",
#     "t1_mbert_multi_base_unfreezing25_fixed_defaultHead_originalData_truncHead_lossCE_predictions.csv",
#     "t1_roberta_en_base_unfreezing75_fixed_avgPoolHead_originalData_truncHeadTail_lossWCE_predictions.csv",
#     "t1_roberta_en_large_unfreezing25_fixed_avgPoolHead_originalData_truncHead_lossWCE_predictions.csv",
#     "t1_xlmr_multi_base_unfreezing25_fixed_defaultHead_originalData_truncHead_lossCE_predictions.csv",
#     "t1_xlmr_multi_large_unfreezing25_fixed_defaultHead_originalData_truncHeadTail_lossWCE_predictions.csv",
# ]

#  # top board after stage 3
ENSEMBLE_FILES = [
    "t1_deberta_en_base_unfreezing25_fixed_multiLayerHead_originalData_truncHeadTail_lossWCE_predictions.csv",
    "t1_deberta_en_base_unfreezing25_fixed_multiLayerHead_originalData_truncHead_lossCE_predictions.csv",
    "t1_deberta_en_base_unfreezing25_fixed_multiLayerHead_originalData_truncHead_lossWCE_predictions.csv",
    "t1_deberta_en_base_unfreezing25_fixed_avgPoolHead_originalData_truncHead_lossCE_predictions.csv",
    "t1_deberta_en_base_unfreezing25_fixed_avgPoolHead_originalData_truncHead_lossWCE_predictions.csv",
    "t1_roberta_en_base_unfreezing75_fixed_avgPoolHead_originalData_truncHeadTail_lossWCE_predictions.csv",
    "t1_deberta_en_base_unfreezing25_fixed_multiLayerHead_head-tail_WCE_Dropout30_NoAug_predictions.csv",
    "t1_deberta_en_base_unfreezing25_fixed_avgPoolHead_originalData_truncHeadTail_lossWCE_predictions.csv",
]
...
OUTPUT_PATH = DATA_DIR / "t1_aBoard_MAJORITYStage3_MBS3_MBS3_MBS3_fixed_MBS3_originalData_MBS3_MBS3_predictions.csv"
