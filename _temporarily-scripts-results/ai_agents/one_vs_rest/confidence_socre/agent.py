...
class Agent:
    ...
    def explain(self, question, answer, predicted_score):
        ...
        prompt = (
            ...
            Explain your decision in 1–2 sentences by explicitly referencing:
            - what the question asks for, and
            - whether the answer directly addresses it or avoids it.

            Do not restate the label definition. Focus only on evidence from the answer.
            """)
